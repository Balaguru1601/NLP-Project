function GraphicResume() {
	return (
		<div className="graphic-resume-container">
			<svg
				style={{ width: "80%" }}
				id="a6dc9487-50e2-4fb9-af91-bf1b7118d463"
				data-name="Resume checking powered by AI"
			...
			>
				...
				<title>
					Our resume checker scans your resume for inconsistencies, length, impact,
					brevity and style. It's powered by Artificial Intelligence.
				</title>
				<ellipse
					cx="843.39"
					cy="664.8"
